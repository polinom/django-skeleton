...
# Enjoy the script? Tip some BTC! 18ZYJyeFAVUiGeWEZRu63NGwrr1ecz1eVR
...
def main():
    ...
    print HASH100
    print '#%sWelcome to django-skeleton!%s#' % (' '*35, ' '*36)
    print '#%sWe will ask you for a project and first app name. Enjoy!%s#' % (' '*21, ' '*21)
    ...
    while input_error:
        ...
        if new_project_name:
            input_error = validate_name(new_project_name)
            if input_error:
                print input_error
                continue
    ...
    while input_error:
        ...
        if new_app_name:
            input_error = validate_name(new_app_name)
            if input_error:
                print input_error
                continue
    ...
    print '    * This will leave you in a clean folder with your fresh django project inside'
    print '    * We strongly recommend you perform this automatic cleanup'
    print 'Would you like to do this? [y/n] (default y): '
    if 'n' in get_user_feedback().lower():
        print 'Okay, we won\'t remove anything'
    else:
        # remove metadata
    ...
    print '    Next steps:'
    print '        1) cd %s/' % new_project_name
    print '        2) python manage.py runserver'
    print '        3) Navigate to http://127.0.0.1:8000/ to enjoy your starter template\n'
    print '        * Checkout my website http://mschettler.com or fork this repo at %s' % (GITHUB_CLONE_CMD.split(' ')[-1])
    print '        * Feeling generous? I accept BTC, Thank you! 18ZYJyeFAVUiGeWEZRu63NGwrr1ecz1eVR\n'
